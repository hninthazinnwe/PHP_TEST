$(document).ready(function(){
      ...
      $('#btnsave').click(function(){  
        ...
        { 
          ...
          $.ajax({
            ...
            method:"post",
            data:{iheader:jsonheader,idetail:jsondetail},
            success:function(data){
                    window.location.href="issue.php";
                    window.open("issuevoucher.php?syskey="+data);
            }
        });
        }
        else
        ...
        $.ajax({
            url:"../dao/transaction.php",
            method:"post",
            data:{uiheader:jsonheader,idetail:jsondetail},
            success:function(data){
                    window.location.href="issue.php";
                    window.open("issuevoucher.php?syskey="+data);
            }
    ...
    $('#btnPrint').click(function(){
        ...
        var tdate = d[1];
        var text = $('#search').val();
        var table = document.getElementById("issuehistory");
        var count = table.rows.length;
    ...
    $("#btnsearch").click(function(){
      ...
      var filter={fdate:fdate,tdate:tdate,search:search};
        ...
        url:"../dao/transaction.php",
        method:"post",
        data:{issuefilter:jsonfilter},
        success:function(data){
           $('#issuehistory').html(data);
        }
      });
    });
...
function DeleteRow()
{
  var index,table = document.getElementById("issuetable");
