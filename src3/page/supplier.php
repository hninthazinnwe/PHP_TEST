...
$result=mysqli_query($conn,"select * from supplier where status<>4");
if(isset($_GET['edit'])){
$id=$_GET['edit'];
$supresult=mysqli_query($conn,"select * from supplier where syskey=$id and status<>4");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ကိုယ္စားလွယ္/supplier
        <!--<small>Control panel</small>-->
      </h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="breadcrumb-item active">ကိုယ္စားလွယ္/supplier</li>
      </ol>
    </section>
    ...
    <div class="row">
        ...
        <div class="box">
          ...
          <div class="box-body no-padding">
            <!-- Tab panes -->
                ...
                <div class="divpad">
                  <label class="mr-25">ကိုယ္စားလွယ္ကုတ္</label>
      ...
      <div class="col-lg-8 col-12" style="float: left;">
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">ကိုယ္စားလွယ္စာရင္း</h4>
            ...
            <table class="table table-bordered table-hover" role="grid" id="customerlist">
              <thead>
                <tr class="bg-dark">
                  ...
                  <th class="text-lighter">ကိုယ္စားလွယ္ကုတ္</th>
                  <th class="text-lighter">ကိုယ္စားလွယ္အမည္</th>
                  <th class="text-lighter">ကိုယ္စားလွအမည္(Myanmar)</th>
                  <th class="text-lighter">မွတ္ပံုတင္အမွတ္</th>
                  <th class="text-lighter">ဖုန္း</th>
                  <th class="text-lighter">လိပ္စာ</th>
    ...
    <?php while($row = mysqli_fetch_assoc($result)):  ?>
      ...
      <td><a class="fa fa-edit" id="edit" href="supplier.php?edit=<?php echo $row['syskey'] ?>" >Edit</a>
      <a class="fa fa-times" href="../dao/setup.php?supdel=<?php echo $row['syskey']; ?>">Delete</a></td>
    </tr>
    <?php $i++;endwhile; ?>
