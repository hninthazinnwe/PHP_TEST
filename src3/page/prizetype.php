...
$result=mysqli_query($conn,"select * from prizetype where status<>4");
if(isset($_GET['edit'])){
$id=$_GET['edit'];
$supresult=mysqli_query($conn,"select * from prizetype where syskey=$id and status<>4");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Prize Type/ဆုမဲအမ်ိဳးအစား
        <!--<small>Control panel</small>-->
      </h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="breadcrumb-item active">Prize Type/ဆုမဲအမ်ိဳးအစား</li>
      </ol>
    </section>
        ...
        <div class="box">
          ...
          <div class="box-body no-padding">
            <!-- Tab panes -->
                ...
                <div class="divpad">
                  <label class="mr-25">Code/ကုတ္အမွတ္</label>
                ...
                <div class="divpad">
                  <label class="mr-25">Description/ဆုမဲအမည္</label>
                  <input class="form-control" type="text"  name="description" id="description" value="<?php echo $description; ?>"></div>
                  <div class="divpad">
                  <label class="mr-25">Amount/ပမာဏ</label>
                  <input class="form-control" type="text"  name="amount" id="amount" value="<?php echo $amount; ?>"></div>  
                  <?php if($isupdate==false): ?>
                  <div class="divpad">
                  <input class="btn btn-block p-10 no-border btn-info" type="button" name="btnsave" id="btnsave" value="Save" aria-expanded="false">
                </div>
               <?php else: ?>
                  <div class="divpad">
			...
			<div class="col-lg-8 col-12" style="float: left;">
				<div class="box">
					<div class="box-header with-border">
					  <h4 class="box-title">Prize List/ဆုမဲစာရင္း</h4>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover" role="grid" id="list">
              <thead>
                <tr class="bg-dark">
                  <th class="text-lighter">No</th>
                  <th class="text-lighter">Code</th>
                  <th class="text-lighter">Description</th>
                  <th class="text-lighter">Amount</th>
    ...
    <?php while($row = mysqli_fetch_assoc($result)):  ?>
      ...
      <td><a class="fa fa-edit" id="edit" href="prizetype.php?edit=<?php echo $row['syskey'] ?>" >Edit</a>
      <a class="fa fa-times" href="../dao/prizetype.php?del=<?php echo $row['syskey']; ?>">Delete</a></td>
    </tr>
    <?php $i++;endwhile; ?>
...
<!-- ./wrapper --> 	 
  ...
  <script>
      ...
      var info="";
      var info={syskey:syskey,code:code,description:description,amount:amount};
      var jsoninfo = "";
      var jsoninfo = JSON.stringify(info);
      if(text == "Save")
      {
      $.ajax({
          url:"../dao/prizetype.php",
          method:"post",
          data:{save:jsoninfo},
          success:function(){
          window.location.href="prizetype.php";          
        }
      });
    }
    else
...
<!-- Mirrored from crypto-admin-templates.multipurposethemes.com/src3/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Sep 2018 04:33:48 GMT -->
</html>
