...
$result=mysqli_query($conn,"select * from staff where status<>4");
if(isset($_GET['edit'])){
$id=$_GET['edit'];
$supresult=mysqli_query($conn,"select * from staff where syskey=$id and status<>4");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="box">
          ...
          <div class="box-body no-padding">
            <!-- Tab panes -->
                ...
                <div class="divpad">
                  <label class="mr-25">Staff Code/၀န္ထမ္းအမွတ္</label>
                ...
                <div class="divpad">
                  <label class="mr-25">Staff Name/၀န္ထမ္းအမည္</label>
                  <input class="form-control" type="text"  name="name" id="name" value="<?php echo $name; ?>"></div>
                <div class="divpad">
                  <label class="mr-25">NRC/မွတ္ပံုတင္</label>
                  <input class="form-control" type="text"  name="nrc" id="nrc" value="<?php echo $nrc; ?>"></div>
                  <div class="divpad">
                  <label class="mr-25">Phone/ဖုန္း</label>
                  <input class="form-control" type="text"  name="phone" id="phone" value="<?php echo $phone; ?>"></div>
                  <div class="divpad">
                  <label class="mr-25">Address/လိပ္စာ</label>
                  <input class="form-control" type="text"  name="address" id="address" value="<?php echo $address; ?>"></div>  
                  <?php if($isupdate==false): ?>
                  <div class="divpad">
    ...
    <?php while($row = mysqli_fetch_assoc($result)):  ?>
      ...
      <td><a class="fa fa-edit" id="edit" href="staff.php?edit=<?php echo $row['syskey'] ?>" >Edit</a>
      <a class="fa fa-times" href="../dao/setup.php?stfdel=<?php echo $row['syskey']; ?>">Delete</a></td>
    </tr>
    <?php $i++;endwhile; ?>
...
<!-- ./wrapper -->   
  ...
  <script>
    ...
    $("#btnsave").click(function(){  
      ...
      var text = $(this).val();
      var info="";
      var info1={syskey:syskey,code:code,name:name,nrc:nrc,phone:phone,address:address};
      var jsoninfo = "";
